...
{
    class DefinicionArchivo: Archivo
    {
        public List<Definicion> Definiciones = new List<Definicion>();
        public DefinicionArchivo() : base(@".\producciones.txt")
        {
            ...
            con.EjecutarQuery("DELETE FROM producciones;");
          
            foreach (Definicion d in Definiciones)
            {
                con.EjecutarQuery(d.getQuery("producciones"));
            }
