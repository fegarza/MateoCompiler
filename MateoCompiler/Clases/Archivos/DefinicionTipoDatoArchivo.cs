...
{
    class DefinicionTipoDatoArchivo: Archivo
    {
        public List<Definicion> Definiciones = new List<Definicion>();
        public DefinicionTipoDatoArchivo() : base(@".\definicionesTipoDato.txt")
        {
            ...
            con.EjecutarQuery("DELETE FROM definicionesTipoDeDato;");
          
            foreach (Definicion d in Definiciones)
            {
                con.EjecutarQuery(d.getQuery("definicionesTipoDeDato"));
            }
